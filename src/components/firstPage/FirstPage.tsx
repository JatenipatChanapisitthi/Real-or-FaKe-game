...
const saveEditedWord = (index: number) => {
  if (editName.trim() !== '' && !nameList.includes(editName.trim())) {
    ...
    <div className="flex flex-col items-center gap-4">
      <div className="flex flex-col  gap-2 border border-black/40 rounded-sm p-5 w-90 md:w-120">
        ...
        <div className="flex gap-4">
          ...
          />
          <button
            className="bg-green-500 w-20 rounded-sm text-white"
          ...
          {nameList.map((name, index) => (
            <div key={index} className="flex items-center gap-2">
              ...
              <div className="flex gap-2 ">
                <button
                  className="bg-green-400 w-14 h-14 rounded-[2px] text-white text-xl flex items-center justify-center cursor-pointer"
                  onClick={() => {
                ...
                <div className="flex gap-2 ">
                <button
                  className="bg-blue-400 w-14 h-14 rounded-[2px] text-white text-xl flex items-center justify-center cursor-pointer"
                  onClick={() => {
